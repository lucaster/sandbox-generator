import { SvgDrawer } from './hex';
import { HexOps } from './hex-ops';

const r = 50;
var hexOps = new HexOps(r);
const svg = document.getElementById('svg') as unknown as SVGElement;
var svgDrawer = new SvgDrawer(svg);
...
svgDrawer.drawImageAtPoint(center_01, 'forest.png', biomeOpts);
svgDrawer.drawImageAtPoint(center_02, 'grassland.png', biomeOpts);
svgDrawer.drawImageAtPoint(center_03, 'hills.png', biomeOpts);
svgDrawer.drawImageAtPoint(center_04, 'marsh.png', biomeOpts);
svgDrawer.drawImageAtPoint(center_05, 'mountains.png', biomeOpts);
svgDrawer.drawImageAtPoint(center_06, 'forest.png', biomeOpts);
svgDrawer.drawImageAtPoint(center_07, 'grassland.png', biomeOpts);
svgDrawer.drawImageAtPoint(center_08, 'hills.png', biomeOpts);
svgDrawer.drawImageAtPoint(center_09, 'marsh.png', biomeOpts);
svgDrawer.drawImageAtPoint(center_10, 'mountains.png', biomeOpts);
svgDrawer.drawImageAtPoint(center_11, 'forest.png', biomeOpts);
svgDrawer.drawImageAtPoint(center_12, 'grassland.png', biomeOpts);
svgDrawer.drawImageAtPoint(center_13, 'hills.png', biomeOpts);
svgDrawer.drawImageAtPoint(center_14, 'marsh.png', biomeOpts);
svgDrawer.drawImageAtPoint(center_15, 'mountains.png', biomeOpts);
svgDrawer.drawImageAtPoint(center_16, 'forest.png', biomeOpts);
svgDrawer.drawImageAtPoint(center_17, 'grassland.png', biomeOpts);
svgDrawer.drawImageAtPoint(center_18, 'hills.png', biomeOpts);
svgDrawer.drawImageAtPoint(center_19, 'marsh.png', biomeOpts);

svgDrawer.drawImageAtPoint(center_01, 'abbey.png');
svgDrawer.drawImageAtPoint(center_02, 'castle.png');
svgDrawer.drawImageAtPoint(center_03, 'city.png');
svgDrawer.drawImageAtPoint(center_04, 'dungeon.png');
svgDrawer.drawImageAtPoint(center_05, 'hamlet.png');
svgDrawer.drawImageAtPoint(center_06, 'lair.png');
svgDrawer.drawImageAtPoint(center_07, 'landmark.png');
svgDrawer.drawImageAtPoint(center_08, 'tower.png');
svgDrawer.drawImageAtPoint(center_09, 'village.png');
svgDrawer.drawImageAtPoint(center_11, 'abbey.png');
svgDrawer.drawImageAtPoint(center_12, 'castle.png');
svgDrawer.drawImageAtPoint(center_13, 'city.png');
svgDrawer.drawImageAtPoint(center_14, 'dungeon.png');
svgDrawer.drawImageAtPoint(center_15, 'hamlet.png');
svgDrawer.drawImageAtPoint(center_16, 'lair.png');
svgDrawer.drawImageAtPoint(center_17, 'landmark.png');
svgDrawer.drawImageAtPoint(center_18, 'tower.png');
svgDrawer.drawImageAtPoint(center_19, 'village.png');
